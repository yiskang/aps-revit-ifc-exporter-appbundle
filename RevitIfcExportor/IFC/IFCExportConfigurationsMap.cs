...
namespace BIM.IFC.Export
{
    ...
    public class IFCExportConfigurationsMap
    {
        ...
        public void AddBuiltInConfigurations()
        {
            ...
            Add(IFCExportConfiguration.CreateBuiltInConfiguration("IFC2x3 Extended FM Handover View", IFCVersion.IFC2x3FM, 1, true, false, false, true, true, false, true, true, false));
        ...
        public void AddSavedConfigurations(Document document)
        {
            try
            {
                ...
                if (m_schema != null)
                {
                    foreach (DataStorage storedSetup in GetSavedConfigurations(m_schema, document))
                    {
        ...
        public void UpdateSavedConfigurations(Document document)
        {
            ...
            if (m_schema != null)
            {
                IList<DataStorage> oldSavedConfigurations = GetSavedConfigurations(m_schema, document);
